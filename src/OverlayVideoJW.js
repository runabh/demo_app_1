    ...
    <div>
      <div className="video-container">
        ...
        <ReactJWPlayer
          ...
          playerScript="https://cdn.jwplayer.com/libraries/r7gOvmQi.js"
          // playlist="https://cdn.jwplayer.com/v2/playlists/gExHXgTO"
          file={
            "https://nowwith-talent-poc.s3.amazonaws.com/1-Favorite-Things-Emily-V16.mov"
          }
          onTime={(e) => {
            setCurrentPlayerTime(Math.floor(e.currentTime));
            checkIfShouldRotate(e.currentTime);
          }}
        />
        <div className="interaction-jw">
